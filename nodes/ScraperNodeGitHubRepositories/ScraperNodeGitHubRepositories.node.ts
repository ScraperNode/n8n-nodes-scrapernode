...
export class ScraperNodeGitHubRepositories extends buildScraperNodeClass({
	scraperId: "github-repositories",
	displayName: "ScraperNode GitHub Repositories",
	nodeName: "scraperNodeGitHubRepositories",
