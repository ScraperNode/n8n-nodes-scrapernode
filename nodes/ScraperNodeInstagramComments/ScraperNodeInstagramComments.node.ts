...
export class ScraperNodeInstagramComments extends buildScraperNodeClass({
	scraperId: "instagram-comments",
	displayName: "ScraperNode Instagram Comments",
	nodeName: "scraperNodeInstagramComments",
